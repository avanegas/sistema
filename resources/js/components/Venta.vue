<template>
                ...
                <div class="card">
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="venta in arrayVenta" :key="venta.id">
                                        <td>
                                            <button type="button" @click="abrirModalVenta(venta.id)" class="btn btn-success btn-sm">
                                            <i class="icon-eye"></i>
                                            </button> &nbsp;
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row border">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Precio <span style="color:red;" v-show="precio_venta==0">(*)</span></label>
                                    <input type="number" disabled value="0" step="any" class="form-control" v-model="precio_venta">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label>Stock <span style="color:red;" v-show="stock==0">(*)</span></label>
                                    <input type="number" disabled value="0" class="form-control" v-model="stock">
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td>
                                                <input v-model="detalle.precio_venta" type="number" disabled value="3" class="form-control">
                                            </td>
                                            <td>
                                                <input v-model="detalle.descuento" type="number" disabled value="4" class="form-control">
                                            </td>
                                            <td>
                                        ...
                                        <tr style="background-color: #CEECF5;">
                                            ...
                                            <td>$ {{totalParcial=(total_venta-totalImpuesto).toFixed(2)}}</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
                                            <td colspan="5" align="right"><strong>Total Impuesto:</strong></td>
                                            <td>$ {{totalImpuesto=((total_venta*impuesto)/(1+impuesto)).toFixed(2)}}</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
                                            <td colspan="5" align="right"><strong>Total Neto:</strong></td>
                                            <td>$ {{total_venta=calcularTotal}}</td>
                                        </tr>
                                    </tbody>
                                    <tbody v-else>
                                        <tr>
            ...
            <!-- Inicio del modal venta -->
            <div class="modal fade" tabindex="-1" :class="{'mostrar' : modalVenta}" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" v-text="tituloModal"></h4>
                            <button type="button" class="close" @click="cerrarModalVenta()" aria-label="Close">
                              <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-md-9">
                                    <label for="">Cliente:</label>
                                    <span class="form-control" v-text="venta.nombre"></span>
                                </div>
                                <div class="col-md-3">
                                    <label for="">Impuesto:</label>
                                    <span class="form-control" v-text="venta.impuesto"></span>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Tipo Comprobante:</label>
                                        <span class="form-control" v-text="venta.tipo_comprobante"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Serie Comprobante:</label>
                                        <span class="form-control" v-text="venta.serie_comprobante"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Número Comprobante:</label>
                                        <span class="form-control" v-text="venta.num_comprobante"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="table-responsive col-md-12">
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            calcularTotal: function(){
                ...
                for(var i=0;i<this.arrayDetalle.length;i++){
                    resultado=resultado+(this.arrayDetalle[i].precio_venta-this.arrayDetalle[i].descuento)*this.arrayDetalle[i].cantidad
                }
                return resultado;
            }
        },
        methods : {
            ...
            buscarArticulo(){
                ...
                axios.get(url).then(function (response) {
                    ...
                    if (me.arrayArticulo.length>0){
                        ...
                        me.precio_venta=me.arrayArticulo[0]['precio_venta'];
            ...
            agregarDetalle(){
                let me=this;
                if(me.idarticulo==0 || me.cantidad==0 || me.precio_venta==0 || me.stock==0){
                }
                else{
            ...
            abrirModalVenta(id){
                this.modalVenta =1;
                this.tituloModal = 'Detalle de venta';
                console.log(id);
                let me=this;
                var url= '/venta/show?id='+id;
                axios.get(url).then(function (response) {
                    console.log(response);
                    var respuesta= response.data;
