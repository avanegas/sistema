                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="num_documento" class="form-control" placeholder="Número documento">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="rol-input">Rol (*)</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="contacto-input">Usuario (*)</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="usuario" class="form-control" placeholder="Nombre de Usuario">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="telefono-input">password (*)</label>
                                    <div class="col-md-9">
    ...
    export default {
        ...
        methods : {
            ...
            desactivarUsuario(id){
                ...
                title: 'Esta seguro?',
                text: "Podrá cambiar más adelante!",
                type: 'warning',
